const sampleData = {
  ...
  artisans: [
    {
      name: 'Ramesh Chand Chippa',
      craft: 'Block Print Textiles',
      location: 'Sanganer, Jaipur',
      yearsOfExperience: 35,
      isFeatured: true,
      bio: 'Ramesh has been practicing the ancient art of hand block printing for over 35 years in Sanganer. His family has been in this craft for four generations, using hand-carved wooden blocks and natural dyes to create intricate floral and geometric patterns on cotton and silk.',
      profileImage: '/images/artisans/ramesh-chippa.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/ramesh-1.jpg',
        '/images/artisans/portfolio/ramesh-2.jpg',
        '/images/artisans/portfolio/ramesh-3.jpg',
      ],
    ...
    },
    {
      ...
      isFeatured: true,
      bio: "Gopal is one of Jaipur's most celebrated blue pottery masters, known for his exceptionally fine brushwork and innovation in form. He trained under the legendary Kripal Singh Shekhawat and has exhibited his work in Delhi, Mumbai, and London.",
      profileImage: '/images/artisans/gopal-kumhar.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/gopal-1.jpg',
        '/images/artisans/portfolio/gopal-2.jpg',
        '/images/artisans/portfolio/gopal-3.jpg',
      ],
      phone: '+91 94141 67890',
      email: 'gopal.bluepottery@gmail.com',
      instagramHandle: '@gopal_bluepottery',
    },
    {
      name: 'Sunita Devi Sonar',
      craft: 'Meenakari Jewellery',
      location: 'Johari Bazaar, Jaipur',
      yearsOfExperience: 20,
      isFeatured: true,
      bio: 'Sunita is one of the few women masters of Meenakari in Jaipur, a craft traditionally dominated by men. She learned the art from her father-in-law and has spent 20 years perfecting the delicate enamel work on gold-plated silver.',
      profileImage: '/images/artisans/sunita-sonar.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/sunita-1.jpg',
        '/images/artisans/portfolio/sunita-2.jpg',
        '/images/artisans/portfolio/sunita-3.jpg',
      ],
      phone: '+91 97843 22222',
      email: null,
      instagramHandle: '@sunita_meenakari',
    },
    {
      name: 'Mohammad Iliyas Manihar',
      craft: 'Lac Bangles',
      location: 'Maniharon ka Rasta, Jaipur',
      yearsOfExperience: 22,
      isFeatured: false,
      bio: 'Mohammad Iliyas runs a small workshop on Maniharon ka Rasta, the famous bangle street of Jaipur. He hand-moulds lac bangles on a heated rod, a skill passed down through seven generations of his family.',
      profileImage: '/images/artisans/iliyas-manihar.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/iliyas-1.jpg',
        '/images/artisans/portfolio/iliyas-2.jpg',
        '/images/artisans/portfolio/iliyas-3.jpg',
      ],
      phone: '+91 99299 44444',
      email: null,
      instagramHandle: null,
    },
    {
      name: 'Deepak Sharma',
      craft: 'Sandalwood Crafts',
      location: 'Tripolia Bazaar, Jaipur',
      yearsOfExperience: 18,
      isFeatured: false,
      bio: 'Deepak is a master wood carver who specialises in sandalwood sculptures and decorative items. He has carved pieces now in private collections across India, the UAE, and the United States.',
      profileImage: '/images/artisans/deepak-sharma.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/deepak-1.jpg',
        '/images/artisans/portfolio/deepak-2.jpg',
        '/images/artisans/portfolio/deepak-3.jpg',
      ],
      phone: '+91 98765 55555',
      email: 'deepak.woodcraft@gmail.com',
      instagramHandle: null,
    },
    {
      name: 'Fatima Bano',
      craft: 'Embroidered Umbrellas',
      location: 'Muhana, Jaipur',
      yearsOfExperience: 15,
      isFeatured: true,
      bio: "Fatima leads a small collective of 12 women artisans who create Jaipur's famous embroidered parasols. She now employs other women from her community, providing them with a steady income from home.",
      profileImage: '/images/artisans/fatima-bano.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/fatima-1.jpg',
        '/images/artisans/portfolio/fatima-2.jpg',
        '/images/artisans/portfolio/fatima-3.jpg',
      ],
      phone: '+91 96721 66666',
      email: null,
      instagramHandle: '@fatima_umbrellas',
    },
    {
      name: 'Suresh Joshi',
      craft: 'Rajasthani Paintings',
      location: 'Chandpole, Jaipur',
      yearsOfExperience: 30,
      isFeatured: false,
      bio: 'Suresh comes from the Joshi family of Bhilwara, hereditary painters of the Phad tradition. He is one of only a handful of artists still practising authentic Phad painting with natural pigments unchanged for 700 years.',
      profileImage: '/images/artisans/suresh-joshi.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/suresh-1.jpg',
        '/images/artisans/portfolio/suresh-2.jpg',
        '/images/artisans/portfolio/suresh-3.jpg',
      ],
      phone: '+91 94600 77777',
      email: 'suresh.phad@gmail.com',
      instagramHandle: '@suresh_phad_art',
    },
    {
      name: 'Leela Devi Bunkar',
      craft: 'Jaipur Carpets',
      location: 'Shastri Nagar, Jaipur',
      yearsOfExperience: 25,
      isFeatured: false,
      bio: 'Leela has been weaving dhurries and carpets on a handloom since the age of 14. She works from a small loom in her home, producing 2-3 carpets a month with geometric patterns inspired by traditional Rajasthani rangoli.',
      profileImage: '/images/artisans/leela-bunkar.jpg',
      portfolioImages: [
        '/images/artisans/portfolio/leela-1.jpg',
        '/images/artisans/portfolio/leela-2.jpg',
        '/images/artisans/portfolio/leela-3.jpg',
      ],
